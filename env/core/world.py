...
class World(object):
    ...
    def init_snake(self):
        ...
        if not self.custom:
            ...
            start_position = (random.randint(4, int(self.size[0])-3), random.randint(4, int(self.size[1])-3))
    ...
    def init_food(self):
        ...
        self.current_available_food_positions = set(self.available_food_positions.difference(set(snake.blocks)))
        if not self.custom:
    ...
    def move_snake(self, action):
        ...
        if self.snake.alive:
            ...
            if (0 in self.snake.blocks[0]) or (self.size[0]-1 in self.snake.blocks[0]):
